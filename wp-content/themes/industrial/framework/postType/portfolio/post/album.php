...
if ($cmsms_project_columns == 'cmsms_four' || $cmsms_project_columns == 'cmsms_three') {
    ...
    $project_thumb = 'project-slider-thumb-full';
}
	...
	<div class="project_content">
		<?php 
			...
			if (sizeof($cmsms_project_images) > 0 && $cmsms_project_images[0] != '') {
				...
				echo '</div>';
			} elseif (sizeof($cmsms_project_images) < 1 && has_post_thumbnail() && $cmsms_project_featured_image_show == 'true' && $cmsms_heading != 'parallax') {
				echo '<div class="resize">';
