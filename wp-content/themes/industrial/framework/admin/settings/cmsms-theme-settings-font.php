...
function cmsms_options_font_fields($set_tab = false) {
	...
	case 'link':
		...
		$options[] = array( 
			'section' => 'link_section', 
			'id' => CMSMS_SHORTNAME . '_footer_link_font', 
			'title' => __('Footer Links Font', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'color', 
			'std' => '#cbccc2' 
		);
	...
	case 'nav':
		$options[] = array( 
			...
			'std' => array( 
				'system_font' => "Arial, Helvetica, 'Nimbus Sans L', sans-serif",  
				'google_font' => 'Raleway:200,400,600,700', 
				'font_color' => '#cc3300', 
				'font_size' => '16', 
				'line_height' => '20', 
				'font_weight' => 'normal', 
	...
	case 'other':
		...
		$options[] = array( 
			'section' => 'other_section', 
			'id' => CMSMS_SHORTNAME . '_footer_h_font', 
			'title' => __('Footer Headings Font Color', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'color', 
			'std' => '#9b9b97' 
		);
