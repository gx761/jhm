		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<span class="icon_upload_link" style="display:none;">' . 
					...
					'<label for="new_icon_title">' . __('Enter Title for This Icon', 'cmsmasters') . '</label>' . 
					'<br /><br />' . 
					...
					"if (jQuery('#new_icon_name').val() !== '') { " . 
						...
						"jQuery('.icon_management ul').append('<li>' + " . 
							"'<div>' + " . 
								...
								"'<input type=\"hidden\" id=\"" . $cmsms_option_name . "_" . $id . "_-_' + icon_number + '\" name=\"" . $cmsms_option_name . "[" . $id . "_-_' + icon_number + ']\" value=\"' + jQuery('#new_icon_name').val() + '|' + jQuery('#new_icon_color').val() + '|' + jQuery('#new_icon_link').val() + '|' + jQuery('#new_icon_title').val() + '|' + ((jQuery('#new_icon_target').is(':checked')) ? 'true' : 'false') + '\" />' + " . 
							"'</div>' + " . 
							"'<a href=\"#\" class=\"icon_del\" title=\"" . __('Delete', 'cmsmasters') . "\">" . __('Delete', 'cmsmasters') . "</a> ' + " . 
							"'<a href=\"#\" class=\"icon_edit\" title=\"" . __('Edit', 'cmsmasters') . "\">" . __('Edit', 'cmsmasters') . "</a> ' + " . 
						"'</li>'); " . 
