...
function cmsms_theme_customizer($wp_customize) {
	...
	// Fixed Header
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_header_nav_fixed]', array( 
		'default' => 0, 
		'type' => 'option' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_header_nav_fixed]', array( 
		'label' => __('Fixed Header', 'cmsmasters'), 
		'section' => 'cmsms_header_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_header_nav_fixed]', 
		'type' => 'checkbox', 
		'priority' => '1' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_nav_numbering]', array( 
		'default' => 0, 
		'type' => 'option' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_nav_numbering]', array( 
		'label' => __('Navigation Numbering', 'cmsmasters'), 
		'section' => 'cmsms_header_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_style_header[' . CMSMS_SHORTNAME . '_nav_numbering]', 
		'type' => 'checkbox', 
		'priority' => '3' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_logo_text[' . CMSMS_SHORTNAME . '_text_logo_title]', array( 
		'default' => ((get_bloginfo('name')) ? get_bloginfo('name') : 'Industrial'), 
		'type' => 'option' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_content[' . CMSMS_SHORTNAME . '_content_font_system_font]', array( 
		'default' => "Arial,Helvetica,'Nimbus Sans L',sans-serif", 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_link[' . CMSMS_SHORTNAME . '_footer_font_font_color]', array( 
		'default' => '#b2b3aa', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, CMSMS_SHORTNAME . '_footer_font_font_color', array( 
		'label' => __('Font Color', 'cmsmasters'), 
		'section' => 'cmsms_font_link_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_link[' . CMSMS_SHORTNAME . '_footer_font_font_color]', 
		'priority' => '9' 
	) ) );
	
	// Footer Links Font Hover Color
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_link[' . CMSMS_SHORTNAME . '_footer_font_hover]', array( 
		'default' => '#323232', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	...
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, CMSMS_SHORTNAME . '_footer_font_hover', array( 
		...
		'section' => 'cmsms_font_link_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_link[' . CMSMS_SHORTNAME . '_footer_font_hover]', 
		'priority' => '10' 
	) ) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_system_font]', array( 
		'default' => "Arial,Helvetica,'Nimbus Sans L',sans-serif", 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_system_font]', array( 
		'label' => __('System Font', 'cmsmasters'), 
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_google_font]', array( 
		'default' => '', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_google_font]', array( 
		'label' => __('Google Font', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_google_font]', 
		'type' => 'select', 
		'choices' => cmsms_google_fonts_list(), 
		'priority' => '2' 
	) );
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_size]', array( 
		'default' => '12', 
		'type' => 'option', 
		'transport' => 'postMessage', 
		'sanitize_callback' => 'check_number' 
	...
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_size]', array( 
		'label' => __('Font Size', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_size]', 
		'type' => 'text', 
		'priority' => '5' 
	) );
	
	// Footer Font Options Line Height
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_line_height]', array( 
		'default' => '18', 
		'type' => 'option', 
		'transport' => 'postMessage', 
		'sanitize_callback' => 'check_number' 
	...
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_line_height]', array( 
		'label' => __('Line Height', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_line_height]', 
		'type' => 'text', 
		'priority' => '6' 
	) );
	
	// Footer Font Options Font Weight
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_weight]', array( 
		'default' => 'normal', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_weight]', array( 
		'label' => __('Font Weight', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
	...
	$wp_customize->add_setting('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_style]', array( 
		'default' => 'normal', 
		'type' => 'option', 
		'transport' => 'postMessage' 
	) );
	
	$wp_customize->add_control('cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_style]', array( 
		'label' => __('Font Style', 'cmsmasters'), 
		'section' => 'cmsms_font_footer_section', 
		'settings' => 'cmsms_options_' . CMSMS_SHORTNAME . '_font_other[' . CMSMS_SHORTNAME . '_footer_font_font_style]', 
		'type' => 'select', 
		'choices' => cmsms_font_style_list(), 
		'priority' => '8' 
	) );
