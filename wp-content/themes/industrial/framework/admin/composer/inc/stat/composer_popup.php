	...
	jQuery(document).ready(function () { 
		...
		jQuery('.add_stats_bar').delegate('#add_stats_bar', 'click', function () { 
			...
			'<tr>' + 
				...
				'</th>' +
				'<td class="field" style="padding-top:10px;">' + 
					'<input type="text" value="#cc3300" name="percent_color' + i + '" id="percent_color' + i + '" aria-required="true" class="popup_tr_value my-color-field" data-default-color="#cc3300" />' + 
				'</td>' + 
			'</tr>';
			...
			<table class="describe">
				<tbody>
					...
					<tr>
						...
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $stats[0]['color']) ? $stats[0]['color'] : '#cc3300'; ?>" name="percent_color0" id="percent_color0" class="popup_tr_value my-color-field" aria-required="true" data-default-color="#cc3300" />
						</td>
					</tr>
					<?php 
						$i = 2;
					...
					?>
							...
							<tr>
								...
								<td class="field" style="padding-top:10px;">
									<input type="text" value="<?php echo ($stats_array_item['color']) ? $stats_array_item['color'] : '#cc3300'; ?>" name="percent_color<?php echo $i; ?>" id="percent_color<?php echo $i; ?>" class="popup_tr_value my-color-field" aria-required="true" data-default-color="#cc3300" />
								</td>
							</tr>
							<script type="text/javascript">
								jQuery(document).ready(function () { 
