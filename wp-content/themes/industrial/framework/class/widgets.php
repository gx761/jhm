					...
					'<div class="cmsms_latest_wrap">';
						...
						if ($pj_format == 'video') {
							...
							if (has_post_thumbnail()) {
								echo '<figure>' . 
									get_the_post_thumbnail(get_the_ID(), 'latest-thumb', array( 
										'class' => 'fullwidth', 
								...
								echo '<figure>' . 
									wp_get_attachment_image($img_number_list[0], 'latest-thumb', false, array( 
										'class' => 'fullwidth', 
										'alt' => cmsms_title(get_the_ID(), false), 
										'title' => cmsms_title(get_the_ID(), false), 
										'style' => 'width:100%; height:auto;' 
						...
						echo '<div class="cmsms_latest_rollover">' . 
							'<div class="cmsms-meta">' . 
								'<div>' . 
			...
			if ($rcomments) { 
				...
				foreach ($rcomments as $comment) {
					...
					echo '<li>' . 
						...
						' <span>' . __('on', 'cmsmasters') . '</span> <a href="' . get_permalink($comment_post_ID) . '#comments" rel="bookmark">' . cmsms_title($comment_post_ID, false) . '</a>' . 
						'<br />' . 
						'<small>' . 
