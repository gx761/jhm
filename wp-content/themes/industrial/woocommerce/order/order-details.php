...
<?php
	if ($order->billing_email) echo '<div><span>'.__( 'Email:', 'woocommerce' ).'</span><strong>'.$order->billing_email.'</strong></div>';
	if ($order->billing_phone) echo '<div><span>'.__( 'Telephone:', 'woocommerce' ).'</span><strong>'.$order->billing_phone.'</strong></div>';
